...
class TestPasswordChangeEndpoint:
    ...
    async def test_change_password_success(self):
        ...
        with patch('app.presentation.api.v1.routers.users.get_current_user') as mock_get_user:
            mock_user = MagicMock()
            mock_user.id = 1
    ...
    async def test_change_password_wrong_current(self):
        ...
        with patch('app.presentation.api.v1.routers.users.verify_password') as mock_verify:
...
class TestPasswordResetEndpoints:
    ...
    async def test_request_password_reset_success(self):
        ...
        with patch('app.presentation.api.v1.routers.auth.send_password_reset_email') as mock_send:
    ...
    async def test_confirm_password_reset_success(self):
        ...
        with patch('app.presentation.api.v1.routers.auth.verify_reset_token') as mock_verify:
...
class TestEmailVerificationEndpoints:
    ...
    async def test_send_email_verification_success(self):
        ...
        with patch('app.presentation.api.v1.routers.users.send_verification_email') as mock_send:
            mock_send.return_value = True
    ...
    async def test_send_email_verification_already_verified(self):
        ...
        with patch('app.presentation.api.v1.routers.users.is_email_verified') as mock_check:
    ...
    async def test_verify_email_success(self):
        ...
        with patch('app.presentation.api.v1.routers.users.verify_email_token') as mock_verify:
...
class TestUserPreferencesEndpoints:
    ...
    async def test_get_preferences_success(self):
        ...
        with patch('app.presentation.api.v1.routers.users.get_user_preferences') as mock_get:
    ...
    async def test_update_preferences_success(self):
        ...
        with patch('app.presentation.api.v1.routers.users.update_user_preferences') as mock_update:
...
class TestUserStatsEndpoint:
    ...
    async def test_get_stats_success(self):
        ...
        with patch('app.presentation.api.v1.routers.users.get_user_stats') as mock_get:
            mock_get.return_value = {
                'saved_jobs': 5,
                'active_alerts': 2,
                'total_searches': 10
...
class TestCacheInvalidation:
    ...
    async def test_cache_invalidated_after_password_change(self):
        ...
        with patch('app.presentation.api.v1.routers.users.invalidate_user_cache') as mock_invalidate:
